...
The test includes a series of functions to conduct the usage scenarios including the required processes divided in 4 groups (0) User Authentication, (1) ERC / Workspace Upload, (2) Metadata editing (i.e. [Candidate process](http://o2r.info/api/compendium/candidate/)) and (3) Compendium execution.
