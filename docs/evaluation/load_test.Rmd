...
1. Direct file upload, see http://o2r.info/api/compendium/upload/
2. Public Share from Zenodo, see http://o2r.info/api/compendium/public_share/#zenodo
...
TODO: distinguish between UI performance and API performance, the latter is the main thing, the former can be a little standalone "sub-scenario"
